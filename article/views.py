...
def get_articles(topic, api_key=api_key, period=7,):
    ...
    if len(data["articles"]) > 0:
        ...
        extracted_data = {
            ...
            "newspaper": most_recent['source']['name']
        }
        
        # Format extracted data as JSON and print it
        json_data = json.dumps(extracted_data, sort_keys=True, indent=4)
...
get_articles("bitcoin", period=18)
